...
from ..generators.builder import MarkdownBuilder
from ..generators.enums import CustomLogos, DefaultLogos
from ..models.dalle import DalleHandler
from ..models.enums import LLMProviders
from ..models.factory import ModelFactory
from ..postprocessor import markdown_to_html, response_cleaner
from ..retrievers.git.repository import load_data
...
def readme_agent(config: ConfigLoader) -> str:
    """Wrap asyncronous README generation process with context manager."""
    with error_handler():
        return asyncio.run(readme_generator(config))


async def readme_generator(config: ConfigLoader) -> str:
